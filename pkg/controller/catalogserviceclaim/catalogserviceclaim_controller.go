...
import (
	...
	tmaxv1 "catalog-service-claim-operator/pkg/apis/tmax/v1"
...
func (r *ReconcileCatalogServiceClaim) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set CatalogServiceClaim instance as the owner and controller
...
func newPodForCR(cr *tmaxv1.CatalogServiceClaim) *corev1.Pod {
